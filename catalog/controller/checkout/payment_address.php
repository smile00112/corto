...
class ControllerCheckoutPaymentAddress extends Controller {
	public function index() {
		...
		$data['order_phone'] = isset($this->session->data['order_phone']) ? $this->session->data['order_phone'] : '' ;
		$data['order_email'] = isset($this->session->data['order_email']) ? $this->session->data['order_email'] : '' ;
		$data['order_comment'] = isset($this->session->data['order_comment']) ? $this->session->data['order_comment'] : '' ;
...
//print_r($_POST);
		...
		$this->session->data['order_phone'] = $this->session->data['order_email'] = $this->session->data['order_comment'] = '';

		if(!empty($this->request->post['order_phone'])) $this->session->data['order_phone'] = $this->request->post['order_phone'];
		if(!empty($this->request->post['order_email'])) $this->session->data['order_email'] = $this->request->post['order_email'];
		if(!empty($this->request->post['order_comment'])) $this->session->data['order_comment'] = $this->request->post['order_comment'];
		...
		if (!$json) {
			...
			if (isset($this->request->post['payment_address']) && $this->request->post['payment_address'] == 'existing') {
				...
				if (!$this->request->post['order_phone']) {
					$json['error']['order_phone'] = 'Введите номер телефона';
				}	
